...
export function createPlayer(camera, scene, renderer) {
  ...
  const held = Object.create(null), stick = { x: 0, y: 0 }; let lookId = null, lastX = 0, lastY = 0, sitting = false;
  const solids = [
